...
const Trainers = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center gap-10  '>
            <h6 id='trainers' className='text-center font-bold text-3xl lg:text-5xl'>Trainners Staff</h6>
            <Carousel
...
<div className='hidden md:grid md:grid-cols-3 lg:grid lg:grid-cols-4 gap-5  justify-center items-center'>
  {data.map((item, index) => (
    <FadeTrainers key={index} index={index}>
      <div className='bg-[#222] flex flex-col justify-center items-center rounded-lg max-w-max hover:bg-[#FAFF00] ease-in duration-300 group cursor-pointer'>
